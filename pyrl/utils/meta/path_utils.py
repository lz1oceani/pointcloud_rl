...
def parse_files(filenames):
    ...
    """
    from pyrl.utils.data import is_seq_of, concat_list
...
def in_directory(folder, directory):
    return os.path.commonprefix([osp.abspath(folder), osp.abspath(directory)]) == directory
